...
AGENT_RANDOM = 2
AGENT_REACTIVE = 3
SEARCH_MODE_BREADTH_FIRST_SEARCH = "BREADTH_FIRST_SEARCH"
SEARCH_MODE_DEPTH_FIRST_SEARCH = "DEPTH_FIRST_SEARCH"
SEARCH_MODE_A_STAR_SEARCH = "A_STAR_SEARCH"
SEARCH_MODE_BEST_FIRST_SEARCH = "BEST_FIRST_SEARCH"
...
class Lab2:
    ...
    def __init__(self):
        ...
        # Search mode for MyVacuumAgent
        self.search_mode_getter = self.create_selection_menu(
            self.update_all,

            ("Breadth-First Search", SEARCH_MODE_BREADTH_FIRST_SEARCH),
            ("Depth-First Search", SEARCH_MODE_DEPTH_FIRST_SEARCH),
            ("A* Search", SEARCH_MODE_A_STAR_SEARCH),
            ("Best-First Search", SEARCH_MODE_BEST_FIRST_SEARCH),
    ...
    def create_sim(self):
        ...
        if selected_agent == AGENT_MYVACUUMAGENT:
            agent = MyVacuumAgent(*self.grid_dims_getter(), self.append_log, self.search_mode_getter())
